...
![Example nwg-dock with base16-onedark colorscheme](./examples/img/onedark.webp)

### base16-google-light

![Example nwg-dock with base16-google-light colorscheme](./examples/img/google-light.webp)
